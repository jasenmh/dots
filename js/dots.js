...
function buildDotsDiv()
{
    ...
    button.setAttribute("onclick", "clearLeds");
    button.value = "Reset LEDs";
    button.type = "button";
    td.appendChild(button);
    tr.appendChild("td");
    td = document.createElement("td");
    button = document.createElement("button");
    button.setAttribute("onclick", "writeAnimOut");
    button.value = "Generate Code";
    button.type = "button";
    td.appendChild(button);
    tr.appendChild(td);
    td = document.createElement("td");
    button = document.createElement("button");
    button.setAttribute("onclick", "loadAnim()");
    button.value = "Load Frame";
    button.type = "button";
    td.appendChild(button);
    tr.appendChild(td);
    td = document.createElement("td");
    ...
    td = document.createElement("td");
    button = document.createElement("button");
    button.setAttribute("onclick", "clearAnimOut()");
    button.value = "Clear Code";
    button.type = "button";
    td.appendChild(button);
    tr.appendChild(td);
    td = document.createElement("td");
    button = document.createElement("button");
    button.setAttribute("onclick", "saveAnim()");
    button.value = "Save Frame";
    button.type = "button";
    td.appendChild(button);
    tr.appendChild(td);
    td = document.createElement("td");
    ...
    td = document.createElement("td");
    button = document.createElement("button");
    button.setAttribute("onclick", "deleteAnim()");
    button.value = "Delete Frame";
    button.type = "button";
    td.appendChild(button);
    tr.appendChild(td);
    tbdy.appendChild(tr);
